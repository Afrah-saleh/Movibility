       ...
       // NavigationView{
        ZStack {
            ...
            if movieDetailState.movie != nil {
                MovieDetailListViewSuggestion(movie: self.movieDetailState.movie!)
...
struct MovieDetailListViewSuggestion: View {
    ...
    struct MovieDetailImageSuggestion: View {
...
#Preview {
    Suggestion(movieId: Movie.stubbedMovie.id)
}
